...
parser.add_argument("--num_beams", type=int, default=1, help="Number of beams for beam search (default: 1).")
...
allowed_prompts = [
    "Fill in the missing letters in this papyrus fragment!",
    "Fill in the missing letters in this inscription!"
]
...
output_file_path = os.path.join(args.output_folder, f"eds_{dataset_name}_{model_name}.jsonl")
